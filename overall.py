    ...
    def starter(self):
        try:
            while rclpy.ok():
                ...
                if self.curr_pos_raw is None or self.map_origin is None or self.map_res is None or self.laser_range is None:
                    continue

                if self.initial_pos is None:
                    self.initial_pos = self.real_to_coords(self.curr_pos_raw)
